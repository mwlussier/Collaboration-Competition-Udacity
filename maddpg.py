...
LR_ACTOR = 1e-5 #2e-4         # learning rate of the actor 
...
class Agent():
    ...
    def soft_update(self, local_model, target_model, tau=1.0):
        ...
        ======
            ...
            tau (float): interpolation parameter; default set to 1.0 to represent a normal(hard) update
        """
...
class OUNoise:
    ...
    def __init__(self, size, seed, mu=0., theta=0.15, sigma=0.10): # initially @ sigma=0.2
